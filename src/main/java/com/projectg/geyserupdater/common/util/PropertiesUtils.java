...
import com.projectg.geyserupdater.common.Updateable;
...
public class PropertiesUtils {
     ...
     */
    public static boolean isLatestBuild(Updateable updateable) throws IOException {
        int jenkinsBuildNumber = WebUtils.getLatestGeyserBuildNumberFromJenkins(updateable.branch);
        int localBuildNumber = updateable.buildNumber;
